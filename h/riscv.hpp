...
public:
    ...
    static void aRegistersPush();
    static void aRegistersPop();
...
inline void Riscv::aRegistersPush() {
    __asm__ volatile ("add sp, sp, -48");
    __asm__ volatile ("sd a0, (sp)");
    __asm__ volatile ("sd a1, 8(sp)");
    __asm__ volatile ("sd a2, 16(sp)");
    __asm__ volatile ("sd a3, 24(sp)");
    __asm__ volatile ("sd a4, 32(sp)");
    __asm__ volatile ("sd a5, 40(sp)");
}

inline void Riscv::aRegistersPop() {
    __asm__ volatile ("ld a0, (sp)");
    __asm__ volatile ("ld a1, 8(sp)");
    __asm__ volatile ("ld a2, 16(sp)");
    __asm__ volatile ("ld a3, 24(sp)");
    __asm__ volatile ("ld a4, 32(sp)");
    __asm__ volatile ("ld a5, 40(sp)");
    __asm__ volatile ("add sp, sp, 48");
}
